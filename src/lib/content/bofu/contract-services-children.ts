...
export const contractServicesChildren: BofuService[] = [
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the contract and a short note on the deal context and the deadline. Pricing and turnaround confirmed within one business day after conflict screen.",
        ],
      },
    ],
    audience: "Small business owners and real-estate operators",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send a short description of the contractor relationship, the work scope, and any draft agreement already on the table. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],
    audience: "Solo founders, agencies, and small businesses hiring 1099 contractors",
    serviceArea: "Statewide TN",
    isLitigation: false,
    primaryCtaLabel: "Send a contract for review",
  },
  {
    ...
    intro:
      "Vendor agreement attorney in Tennessee for small businesses negotiating supplier, SaaS, and service contracts — drafting from scratch when needed and reviewing what the vendor sent before it gets signed.",
    sections: [
      {
        h2: "What this covers",
        paragraphs: [
          "Vendor agreement work focuses on what actually drives disputes: pricing and payment terms, service-level commitments, change-order mechanics, data and confidentiality, indemnification, limits of liability, termination rights, and renewal.",
          "Where the vendor is a SaaS provider, additional attention goes to data-handling, security, uptime commitments, and exit-data provisions that determine what the client retains when the relationship ends.",
        ],
      },
      {
        h2: "Who this is for",
        paragraphs: [
          "Small businesses signing a recurring vendor relationship. Companies negotiating SaaS or technology agreements. Real-estate operators with vendors providing recurring services across multiple properties.",
        ],
      },
      {
        h2: "Common issues caught",
        paragraphs: [
          "Auto-renewal and termination-notice provisions that lock the client in. Liability caps that fail to cover the actual loss the client would suffer if the vendor fails. Data and confidentiality terms that miss exit-data rights. Forum and arbitration provisions that change dispute leverage.",
        ],
      },
      {
        h2: "Process and pricing",
        paragraphs: [
          "Flat-fee or capped pricing for vendor-agreement review. Turnaround typically two to three business days; rush available when the deal is on a clock.",
        ],
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the vendor's draft and a short note on the relationship and the deadline. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the existing draft (if any), a short note on the property and parties, and the deadline. Pricing and turnaround returned within one business day after conflict screen.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the existing draft, a short note on the project, and any deadline. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],
    audience: "Contractors, subcontractors, suppliers, and owners",
    serviceArea: "Statewide TN",
    isLitigation: false,
    primaryCtaLabel: "Send a contract for review",
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the lease or LOI, a short note on the deal, and the deadline. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],
    audience: "Commercial tenants, landlords, investors, and brokers",
    serviceArea: "Statewide TN (drafting); trial counties (disputes)",
    isLitigation: false,
    primaryCtaLabel: "Send a contract for review",
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the draft (if any) and a short note on the relationship and the information at stake. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the existing MSA (if any) and a short note on the business model and the typical client engagement. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the LOI or term sheet, a short summary of the business and the assets, and the target closing date. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "How to start",
        paragraphs: [
          "Send the LOI (if any) and a short note on the deal and the timing. Pricing and turnaround within one business day after conflict screen.",
        ],
      },
    ],

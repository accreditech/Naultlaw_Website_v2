...
export const contractServicesChildren: BofuService[] = [
  {
    ...
    sections: [
      {
        h2: "The clauses that bite when a deal goes sideways",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      {
        h2: "Misclassification is the exposure that does not show up until later",
        paragraphs: [
      ...
      {
        h2: "Owning the work, and keeping what is yours",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      {
        h2: "The lock-in you do not see until renewal",
        paragraphs: [
      ...
      {
        h2: "SaaS adds a question most contracts skip — what happens to your data",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      {
        h2: "Get the lien and payment rights set before the job starts",
        paragraphs: [
      ...
      {
        h2: "Prime contracts, AIA forms, and the flow-through to subs",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Default, cure, and the leverage that surfaces in a dispute",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      {
        h2: "Protection that holds up beats language that sounds tough",
        paragraphs: [
      ...
      {
        h2: "Where the NDA meets the rest of the relationship",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      {
        h2: "What the APA is really allocating",
        paragraphs: [
      ...
      {
        h2: "The pieces around the agreement",
        paragraphs: [

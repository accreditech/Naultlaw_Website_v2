...
export const realEstateTransactionsChildren: BofuService[] = [
  {
    ...
    audience: "Buyers, sellers, FSBOs, and real-estate investors",
  ...
  },
  {
    ...
    audience: "Sellers and buyers structuring installment land sales",
    serviceArea: "Statewide TN",
    isLitigation: false,
    primaryCtaLabel: "Schedule a Consultation",
  },
  {
    ...
    audience: "Real-estate operators and capital partners",
    serviceArea: "Statewide TN",
    isLitigation: false,
    primaryCtaLabel: "Schedule a Consultation",
  },
  {
    ...
    audience: "Wholesalers, investors, and parties assigning purchase agreements",
    serviceArea: "Statewide TN",
    isLitigation: false,
    primaryCtaLabel: "Send a contract for review",
    needsSteveReview: [

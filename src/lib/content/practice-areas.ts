...
export const practiceAreas: PracticeAreaContent[] = [
  {
    ...
    narrative: [
      "The leverage hides in the clauses. Early in my career, I saw how one sentence in a small Boston sub shop's lease likely saved the owner from bankruptcy. That term was an exclusivity right to sell \"sub-style sandwiches.\" As a result of this one sentence, the developer paid the owner $500,000 and gave him an early exit before bringing Panera into the same center. The locally owned shop closed months later, but the owner used the buyout to open two new locations. This one sentence was the difference between an early exit to bankruptcy court, and the ability to negotiate a term that saved his entire livelihood.",
      "In another lease, I represented a landlord who brought rent back to market value during a renewal. The tenant's residential agent missed that the \"base tax year\" for tax pass-throughs should have been reset as well. The industry practice was clear. Their representation however was not. That oversight cost the tenant hundreds of thousands of dollars over the remaining lease term.",

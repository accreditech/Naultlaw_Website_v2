export type ResourceContent = {
  ...
  body: string[];
  /** Optional /services/<slug> links surfaced as related practice pages
      after the article body. Drives internal-link equity to BOFU pages. */
...
export const resources: ResourceContent[] = [
  {
    ...
    audience: [
      ...
      "Owners whose neighbor is claiming their fence or structure encroaches",
    ...
    relatedServices: [
      {
        ...
        label: "Property Line Disputes",
      },
      { slug: "quiet-title-attorney-tennessee", label: "Quiet Title" },
      { slug: "easement-attorney-tennessee", label: "Easements" },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedServices: [
      { slug: "real-estate-commission-dispute-expert-witness-tennessee", label: "Real Estate Commission Dispute Expert Witness" },
      { slug: "realtor-dispute-expert-witness-tennessee", label: "Realtor Dispute Expert Witness" },
    ],
  },
  {
    ...
    body: [
      "In Tennessee real-estate transaction disputes involving licensed conduct, the same set of facts can matter in more than one setting. A complaint to the Tennessee Real Estate Commission may raise a regulatory question, while the same underlying facts may also matter in [a private civil dispute](/practice-areas/real-estate-disputes). Those paths are not the same, and they do not do the same work. TREC's complaint page states that the Commission can review and discipline improper or illegal licensed conduct, but it cannot recover or order the refund of money or property; if money or property recovery is the goal, the Commission directs readers to civil court.",
  ...
  },
  {
    ...
    body: [
      ...
      "Informal practices can deepen the problem. Grubb is especially useful here because the Court of Appeals rejected a supposed equal-compensation arrangement where the alleged agreement was described as 'unspoken' and 'just the way it's been.' The court held that, on that record, there was no meeting of the minds and no enforceable agreement on those terms. That does not mean every informal practice in every LLC is legally meaningless. It does mean that unspoken understandings become proof problems when the relationship breaks down. The more important the issue - authority, compensation, ownership expectations, or economic rights - the more dangerous it is when the business relies on memory and habit instead of [clear company documentation](/services/operating-agreement-attorney-tennessee).",
      ...
      "The practical takeaway is that real deadlock in a Tennessee LLC usually appears as a cluster of issues rather than a single dramatic event: voting paralysis, conflicting authority, control over money, records disputes, ownership-story drift, and compensation conflict. Once those issues begin to overlap, the problem is usually bigger than interpersonal friction. It is a [governance problem](/practice-areas/operating-agreements-and-owner-disputes), a proof problem, and often a business-continuity problem at the same time.",
  ...
  },
  {
    ...
    body: [
      ...
      "This article is intentionally narrow. It is about Tennessee LLC disputes and [closely held business control problems](/services/business-partnership-dispute-attorney-tennessee) involving LLCs. The authorities cited here are LLC-focused and should not be generalized to corporations, partnerships, or other entity forms without separate research.",
      ...
      "The same case also shows why current-member versus former-member status matters. Under the Tennessee Revised Limited Liability Company Act, the court noted that both members and former members can have access rights to LLC records, but former members' rights are narrower and limited to proper purposes tied to the periods during which they were members. In other words, status is not just a label. It can affect what rights are still in play and [how the dispute gets framed](/practice-areas/operating-agreements-and-owner-disputes).",
  ...
  },
  {
    ...
    relatedServices: [
      { slug: "shareholder-dispute-attorney-tennessee", label: "Shareholder Dispute Attorney" },
      { slug: "business-partnership-dispute-attorney-tennessee", label: "Business Partnership Dispute Attorney" },
      { slug: "breach-of-fiduciary-duty-attorney-tennessee", label: "Breach of Fiduciary Duty Attorney" },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedServices: [
      ...
      { slug: "tenant-attorney-tennessee", label: "Tenant Attorney in Tennessee" },
    ],
  },
  {
    ...
    body: [
      ...
      "Transfer rights, assignment language, and sublease restrictions also deserve [closer review](/services/contract-review-attorney-tennessee) than they often get. A business can perform well under a lease and still run into trouble when it wants to restructure, sell, relocate, or react to a changing occupancy plan.",
      "Operating covenants, CAM language, repair obligations, exclusives, and guaranty terms are where the practical economics of the relationship often live. The point of [careful review](/practice-areas/commercial-leasing) is not to redline everything into a stalemate. It is to focus attention where the business would actually feel pain if the document were enforced literally.",
    ],
    relatedServices: [
      { slug: "commercial-lease-attorney-tennessee", label: "Commercial Lease Attorney in Tennessee" },
  ...
  },
  {
    ...
    body: [
      ...
      "The first practical move is to gather the complaint packet, response deadline, communications, disclosures, brokerage context, and transaction chronology. That work often reveals that [the visible issue is only part of the problem](/practice-areas/strategic-case-assessment), or that the complaint is narrower than it first appeared.",
      ...
      "What matters most is [a measured, credible response](/practice-areas/trec-defense-and-realtor-complaints) tied to the actual record. That usually means organizing the file before choosing tone, not after.",
    ],
    relatedServices: [
      { slug: "trec-complaint-expert-witness-tennessee", label: "TREC Complaint Expert Witness" },
      { slug: "agent-malpractice-expert-witness-tennessee", label: "Agent Malpractice Expert Witness" },
  ...
  },
  {
    ...
    body: [
      ...
      "Those signs matter because they usually point to [a control problem](/practice-areas/operating-agreements-and-owner-disputes), not just a personality problem. When an owner dispute touches account access, property decisions, vendor control, leasing, or records, the business can slow down long before anyone files anything formal.",
      "The right early move is often not immediate escalation for its own sake. It is disciplined fact gathering, a clear read of the governing documents, and a practical decision about whether the matter should be [negotiated, restructured, or prepared for a harder dispute path](/practice-areas/arbitration-and-dispute-resolution).",
  ...
  },
  {
    ...
    body: [
      ...
      "That is what [Investigate and Advise](/practice-areas/strategic-case-assessment) is for. The work is structured to test assumptions, organize the chronology, identify what claims or defenses may actually matter, and evaluate whether the business objective would be served by negotiation, a demand, [arbitration planning](/practice-areas/arbitration-and-dispute-resolution), or litigation positioning.",

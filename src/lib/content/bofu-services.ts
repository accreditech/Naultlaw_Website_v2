...
export const bofuHubs: BofuHub[] = [
  {
    ...
    narrative: [
      ...
      "Engagements are scoped at the front. The initial review covers the complaint, the brokerage or transaction file, and a short call to confirm fit and conflicts. From there, written report, deposition support, and trial testimony follow as the matter requires. Hourly billing applies, with retainers sized to the case rather than a one-size-fits-all rate sheet. CV and prior testimony list are made available on request after conflict screening. The work avoids overreach: opinions are limited to what the record supports and what industry custom actually establishes — not advocacy disguised as analysis.",
    ],
    whenToCall:
